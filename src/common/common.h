...
struct Value
{
	...
	[[nodiscard]] bool incompatible_type_compare(const Value& b) const
	{
		return (this->type == TYPE_STRING && b.type != TYPE_STRING)
			|| (this->type != TYPE_STRING && b.type == TYPE_STRING);
	}
