...
enum yysymbol_kind_t
{
	...
	YYSYMBOL_VALUE_INVALID = 52,             /* VALUE_INVALID  */
	...
	YYSYMBOL_order_clauses = 89,             /* order_clauses  */
...
static const char* const yytname[] =
	{
		...
		"tbName", "colName", "asName", "fileName", YY_NULLPTR
	};
...
static const yytype_int16 yypact[] =
	{
		60, 4, 6, 16, -44, 56, 27, 23, -44, -1,
		-94, -94, -94, -94, -94, -94, -94, 71, 41, -94,
		-94, -94, -94, -94, 73, -44, -44, -44, -44, -94,
		-94, -44, -44, -94, 74, 76, 48, 63, 68, 69,
		66, -94, -94, -94, 70, 115, 72, -94, -94, -94,
		-44, 75, 77, -94, 78, 118, 110, -44, 88, -38,
		89, 89, 89, 14, -44, 88, -94, 88, 88, 88,
		82, 89, -94, -94, -94, -19, -94, 79, 84, 86,
		87, 90, 91, -94, -94, -14, -94, -94, -29, -94,
		85, 3, -94, 32, 59, -94, 104, 30, 88, -94,
		59, 120, 123, 124, 127, 128, -44, -44, 135, -94,
		88, -94, -94, -94, 96, -94, -94, -94, 88, -94,
		-94, -94, -94, -94, -94, -94, 37, -94, 89, -94,
		-94, -94, -94, -94, -94, 29, -94, -94, 105, 105,
		105, 105, 105, -94, -94, 138, -94, -94, 106, -94,
		-94, 59, -94, -94, -94, -94, -94, -94, -94, -94,
		-94, -94, 89, 100, -94, 33, -21, -94, -94, -94,
		-94, -94, 108, 89, -94, -94
	};
...
static const yytype_int8 yypgoto[] =
	{
		-94, -94, -94, -94, -94, -94, -94, -94, 92, 49,
		-94, -94, -93, 34, -40, -94, 95, -9, -94, -94,
		-94, -94, 62, -94, -94, -94, -94, -10, -94, -2,
		-54, -20, -94
	};
...
static const yytype_int16 yytable[] =
	{
		43, 172, 30, 29, 77, 71, 35, 137, 23, 40,
		71, 87, 25, 90, 92, 92, 36, 37, 38, 39,
		78, 106, 27, 51, 52, 53, 54, 109, 110, 55,
		56, 36, 37, 38, 39, 99, 173, 24, 98, 26,
		32, 169, 153, 107, 77, 108, 40, 170, 66, 28,
		79, 80, 81, 82, 84, 73, 90, 41, 164, 117,
		118, 40, 86, 1, 149, 2, 31, 3, 4, 5,
		33, 48, 6, 129, 130, 131, 40, 120, 121, 122,
		123, 124, 125, 7, 57, 8, 50, 9, 119, 118,
		132, 133, 134, 150, 151, 49, 10, 11, 12, 13,
		14, 15, 58, 59, 143, 144, 16, 120, 121, 122,
		123, 124, 125, 111, 112, 113, 114, 115, 60, 158,
		159, 160, 161, 61, 62, -85, 154, 63, 64, 70,
		67, 65, 68, 69, 71, 74, 40, 94, 128, 100,
		101, 138, 102, 103, 139, 140, 104, 105, 141, 142,
		145, 148, 156, 165, 162, 163, 168, 174, 83, 147,
		136, 93, 152, 175, 165
	};

static const yytype_uint8 yycheck[] =
	{
		9, 22, 4, 47, 58, 24, 8, 100, 4, 47,
		24, 65, 6, 67, 68, 69, 17, 18, 19, 20,
		58, 35, 6, 25, 26, 27, 28, 56, 57, 31,
		32, 17, 18, 19, 20, 75, 57, 33, 57, 33,
		13, 8, 135, 57, 98, 85, 47, 14, 50, 33,
		59, 60, 61, 62, 63, 57, 110, 58, 151, 56,
		57, 47, 64, 3, 118, 5, 10, 7, 8, 9,
		47, 0, 12, 43, 44, 45, 47, 48, 49, 50,
		51, 52, 53, 23, 10, 25, 13, 27, 56, 57,
		60, 61, 62, 56, 57, 54, 36, 37, 38, 39,
		40, 41, 26, 55, 106, 107, 46, 48, 49, 50,
		51, 52, 53, 28, 29, 30, 31, 32, 55, 139,
		140, 141, 142, 55, 55, 59, 135, 57, 13, 11,
		55, 59, 55, 55, 24, 47, 47, 55, 34, 60,
		56, 21, 56, 56, 21, 21, 56, 56, 21, 21,
		15, 55, 47, 162, 16, 49, 56, 49, 63, 110,
		98, 69, 128, 173, 173
	};
...
static const yytype_int8 yystos[] =
	{
		...
		36, 37, 38, 39, 40, 41, 46, 64, 65, 66,
		67, 68, 69, 4, 33, 6, 33, 6, 33, 47,
		92, 10, 13, 47, 95, 92, 17, 18, 19, 20,
		47, 58, 79, 80, 81, 86, 92, 93, 0, 54,
		13, 92, 92, 92, 92, 92, 92, 10, 26, 55,
		55, 55, 55, 57, 13, 59, 92, 55, 55, 55,
		11, 24, 77, 92, 47, 84, 85, 93, 58, 80,
		80, 80, 80, 79, 80, 87, 92, 93, 70, 72,
		93, 71, 93, 71, 55, 76, 78, 80, 57, 77,
		60, 56, 56, 56, 56, 56, 35, 57, 77, 56,
		57, 28, 29, 30, 31, 32, 73, 56, 57, 56,
		48, 49, 50, 51, 52, 53, 74, 75, 34, 43,
		44, 45, 60, 61, 62, 82, 85, 75, 21, 21,
		21, 21, 21, 92, 92, 15, 88, 72, 55, 93,
		56, 57, 76, 75, 80, 83, 47, 94, 94, 94,
		94, 94, 16, 49, 75, 80, 89, 90, 56, 8,
		14, 91, 22, 57, 49, 90
	};
...
#line 162 "/home/pygone/projects/db2023-one/src/parser/yacc.y"
	{
		(yyval.sv_node) = std::make_shared<SelectStmt>((yyvsp[-4].sv_cols),
			(yyvsp[-2].sv_strs),
			(yyvsp[-1].sv_conds),
			(yyvsp[0].sv_order_clause));
	}
...
#line 1974 "/home/pygone/projects/db2023-one/src/parser/yacc.tab.cpp"
		break;
...
#line 1982 "/home/pygone/projects/db2023-one/src/parser/yacc.tab.cpp"
		break;
...
#line 1990 "/home/pygone/projects/db2023-one/src/parser/yacc.tab.cpp"
		break;
...
#line 2220 "/home/pygone/projects/db2023-one/src/parser/yacc.tab.cpp"
		break;
...
#line 2228 "/home/pygone/projects/db2023-one/src/parser/yacc.tab.cpp"
		break;
...
#line 2236 "/home/pygone/projects/db2023-one/src/parser/yacc.tab.cpp"
		break;
...
#line 2244 "/home/pygone/projects/db2023-one/src/parser/yacc.tab.cpp"
		break;

	case 78: /* opt_order_clause: %empty  */
#line 426 "/home/pygone/projects/db2023-one/src/parser/yacc.y"
	{ /* ignore*/ }
#line 2250 "/home/pygone/projects/db2023-one/src/parser/yacc.tab.cpp"
		break;
...
#line 2258 "/home/pygone/projects/db2023-one/src/parser/yacc.tab.cpp"
		break;
...
#line 2266 "/home/pygone/projects/db2023-one/src/parser/yacc.tab.cpp"
		break;
...
#line 2274 "/home/pygone/projects/db2023-one/src/parser/yacc.tab.cpp"
		break;
...
#line 2280 "/home/pygone/projects/db2023-one/src/parser/yacc.tab.cpp"
		break;
...
#line 2292 "/home/pygone/projects/db2023-one/src/parser/yacc.tab.cpp"
		break;

#line 2296 "/home/pygone/projects/db2023-one/src/parser/yacc.tab.cpp"
